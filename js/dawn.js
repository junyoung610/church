// junyoung610/.../js/dawn.js - 최종 완성 및 오류 수정 버전
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const currentPath = window.location.pathname; // ----------------------------------------------------- // II. 글쓰기/수정 페이지 (dawn/write.html) 로직 // -----------------------------------------------------
  ...
  } // ----------------------------------------------------- // IV. 상세 보기 페이지 (dawn/view.html) 로직 // -----------------------------------------------------

  if (currentPath.includes("dawn/view.html")) {
    const urlParams = new URLSearchParams(window.location.search);
    const postId = urlParams.get("id");
